...
const ContentEndMarker: React.FC<ContentEndMarkerProps> = ({handleOnIntersect, threshold, endMarkerHeight}) => {
    ...
    return <div className={"ao-body5-content-end-marker"}
                style={{
                    display: "flex",
                    position: "relative",
        ...
        <div className={"ao-body5-content-end-marker-bg"} style={{
            display: "flex",
            position: "relative",
            width: "100%",
            height: "100%",
        ...
        <div ref={endOfBackGroundMarker} className={"ao-body5-end-bg-marker"}
...
const ContentImage: React.FC<{
    ...
    return <>
        <div className={"ao-body5-content-image-wrapper"}
            // ref={wrapperRef}
             style={{
                 display: "flex",
                 overflow: "hidden",
            ...
            <div ref={endOfBackgroundMarkerRef} className={"ao-body5-end-bg-marker"}
                 style={{display: "flex", width: "100%"}}></div>
            {showBubble &&
                <div className={"ao-body5-bubbles-wrapper"} style={{
                    width: "100%",
                    display: "flex",
                    justifyContent: "center",
                    // alignItems: "center",
                    ...
                    <div className={"ao-body5-small-bubble-wrapper ao-body5-bubble-animate"} style={{
                        backgroundColor: "red",
                    ...
                    <div className={"ao-body5-big-bubble-wrapper ao-body5-bubble-animate"} style={{
                        backgroundColor: "red",
...
export const Content: React.FC<ContentProps> = ({
    ...
    return <div className={"ao-body5-content"}
                style={{
                    display: "flex",
                    overflow: "hidden",
                    flexDirection: "column",
        ...
        ></ContentImage>
        <Parallax className={"ao-body5-parallax"} pages={1.5}
                  style={{
                      display: "flex",
                      position: "absolute",
                      justifyContent: "center",
            ...
            <ParallaxLayer offset={0.25} speed={1.5}
                ...
                <div className={"ao-body5-content-parallax-layer"}
                     style={{
                         display: "flex",
                    ...
                    <div className={"ao-body5-content-text-wrapper"} style={{
                        display: "flex",
                        position: "relative",
                        justifyContent: "center",
                        alignItems: "center",
                        ...
                        <div className={"ao-body5-content-text-bg"} style={{
                            display: "flex",
                            position: "absolute",
                            width: "100%",
                            height: "100%",
                        ...
                        <div className={"ao-body5-content-text-paragraphs"}
                             style={{
                                 height: "100%",
