export const FirstPitch = () => {
    return {
        ...
        ExteriorDescriptions: [
            {
                label: "bonnet",
                text: "The wide bonnet and low, aggressive stance hints at the SL's capabilities.",
                credit: "PHOTO: sgCarMart",
                imgRef: "img_bonnet"
            },
            {
                label: "exhaust",
                text: "You won't always see the quad exhaust tips, but you'll definitely hear their symphony.",
                credit: "PHOTO: sgCarMart",
                imgRef: "img_exhaust"
            },
            {
